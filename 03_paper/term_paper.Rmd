...
## Partial Dependence Plots for Bootstrap Aggregation

```{r, echo = FALSE, fig.cap = "\\label{fig:bgpardep_main}Random Forest: Partial Dependence Plots."}
knitr::include_graphics("../00_data/output_paper/16_pdp_boosting_main.pdf")
```

```{r, echo = FALSE, fig.cap = "\\label{fig:bgpardep_other}Random Forest: Partial Dependence Plots."}
knitr::include_graphics("../00_data/output_paper/16_pdp_boosting_other.pdf")
```
