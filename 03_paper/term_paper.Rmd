...
The 25 Tree \ac{bagging} Model (\ac{rmse} of $\approx 4305$) outperforms the Random Forest Model (with 25 Trees and 100 Variables) only by a small margin (\ac{rmse} of $4374.330$). However, training the Random Forest demands only $15\%$ of the time, that the \ac{bagging} Model needs.
