...
Figure \ref{fig:rmsebag} shows the RMSE values of different bagging models. One can see that even small models with down to 15 Trees significantly outperform the single tree model of the previous chapter.
...
To further analyze the bagging model, we estimated a bagging model with 25 trees for the whole dataset. Figure \ref{fig:bagvarimp} is a variable importance plot for this model. It presents those 20 variables which would increase the RMSE the most when being omitted.
