...
The data used in this term paper is taken from a wine themed dataset. The variables include among others the name of the wine, the country of origin, its price, the amount (litres), the taste segment and some variables releated to diffeerent reviews.
<!---
