...
Figure \ref{fig:rfimp} shows partial dependence plots for the 10 most important variables. The plots present the marginal effect of the variable on the litre. Those plots clearly reveal some nonlinear dependences in the data which explains the poor performes of the linear models. Furthermore the figure validates some intuitive assumptions. For example, a higher market shares leads to more litres sold while high real prices lead to fewer litres sold. Furthermore the influence of $v10\_dim$ which is the 'Dagens Industri' review is especially big, when the review is very good. Figure \ref{fig:rfpardep_other} presents the partial dependence plots for the next 10 important variables.
