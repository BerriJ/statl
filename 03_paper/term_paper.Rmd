...
The partial dependence plots are very similar to those from the random forest model. Therefore, and to keep this paper at a reasonable size, they are not discussed but included as \ref{fig:bgpardep_main} in appendix \ref{chap:ap2}.
...
As noted in chapter \ref{chap:data}, we excluded "$time\_segm\_price$" and "$artikpr$", thus they represent interactions terms. Including them yields a mean \ac{rmse} of $\approx4862.917$ and therefore doesn't improve our model.
