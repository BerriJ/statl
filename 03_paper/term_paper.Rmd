...
Although the main goal is an accurate forecast, some of the methods used in this paper can also be used to quantify the impact of expert reviews on the sales, if there is any influence. The effect of expert opinion on consumer demand was analyzed in preceeding research. E.g. \textcite[][]{Hilger2011} use a field experiment to study a review-based demand effect using wine score labels in a retail grocery chain. Moreover, \textcite[][p. 293.]{Ashenfelter2013} analyzed, wether expert reviews influence the prices of wine. They conclude, that expert reviews contain public as well as private information. Furthermore they only validate an influence on the highest rated whines.  
