...
components analysis. The first principal components represent roughly
3\% of the total variance. This is a sign that the PCA doesn't work well
in our data which is due to the large amount of dummy variables.
