...
validation set approach' \autocite[][p. 308]{James2014}, p.~308{]}. This
is done by \emph{cost complexity pruning}.
...
models. One can see that even small models with down to 15 Trees
significantly outperform the single tree model of the previous chapter.
...
would increase the RMSE the most when being omitted.
