...
set have been used at every iteration. According to our calculations the
optimal boosting model is the one with \(25\) trees used, an interaction
depth of \(15\) and a shrinkage parameter of \(0.4\).
...
The use of more trees and / or more variables just barely increases the
