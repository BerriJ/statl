...
\caption[RMSE's of the Random Forest for Different Parameters]{Random Forest: Dependency between RMSE, the Number of Trees and the Number of Variables Included at each Split}\label{fig:unnamed-chunk-11}
\end{figure}
...
\caption[RMSE's of the Boosting Model for Different Parameters]{Boosting: Dependency between RMSE, Lambda, the Depths and the Number of Trees that are Grown}\label{fig:unnamed-chunk-12}
\end{figure}
