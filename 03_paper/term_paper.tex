...
combining shrinkage of the coefficent estimates as well as variable
selection. Basically it fits a linear model but is constrained by a
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{load}\NormalTok{(}\StringTok{"../02\_analysis/cv/lasso/models\_df\_20190816\_1222\_1.rda"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
