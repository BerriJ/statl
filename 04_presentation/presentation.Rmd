---
title: 'A Forecasting Study on Swedish Wine Sales `r fontawesome::fa("wine-bottle", fill = "#b50000", height = 39)`'
...
<h1 id="analysis">Random Forest <i class="fas fa-trees"></i> </h1>
