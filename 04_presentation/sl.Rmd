...
So clrearly some predictors are useful. 
...
???
- RMSE does slightly depend on used fold but common tendencies can be seen
...
- Taking residuals from current tree, fitting small tree to these and fitting fitted tree into current boosting tree wgere performance could be improved
- Expansion of tree but also growing dependence
- Other tuning parameter in R, in gbm()-function: bag.fraction 
  - We set this to 1 so that everytime the complete training set has been used
